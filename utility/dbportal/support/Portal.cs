/// ------------------------------------------------------------------
/// Copyright (c) 1996, 2015 Vincent Risi 
///           in Association Barone Budge Dominick
/// All rights reserved.
...
///    Vincent Risi
/// ------------------------------------------------------------------
/// System : JPortal and DBPortal
/// ------------------------------------------------------------------

using System;
using System.Data;

namespace Portal.AdoNet
{
  ...
  public class Cursor : IDisposable
  {
    ...
    public int GetInt32(int ordinal)
    {
      ...
      {
        long result = (long)reader.GetInt64(ordinal);
        return (int)result;
      }
    }
