...
JP_INTERNAL(SQLRETURN) JP_BindInt64Array(TJQuery &qry,  int32 bindNo, int64 *data, SQLLEN* indicators);
...
JP_INTERNAL(void) JP_BigSequence(TJQuery& qry, int64 &sequence, const char *sequencer);
...
void TJConnector::ThrowOnError(char const *file, int32 line)
{
  if (result != 0)
  {
    TCliApiException ex(result, state, allow, msgbuf, file, line);
...
void TJQuery::BindInt64Array(int32 bindNo, int64 *data, SQLLEN* null)
{
