...
JP_INTERNAL(SQLRETURN) JP_CheckConnect(TJConnector &conn, SQLINTEGER &attr);
...
void TJQuery::Clear()
{
  ...
  if (noIndicators)
    memset(indicators, 0, noIndicators * sizeof(SQLINTEGER));
}
