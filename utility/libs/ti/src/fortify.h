...
#define __FORTIFY_H__"$Revision: 92 $ $Date: 2005-04-21 11:34:40 +0200 (Thu, 21 Apr 2005) $"
#include "versions.h"
HEADER_VERSION(__FORTIFY_H__);
#include <stdlib.h>
#include <string.h>
...
typedef void (*Fortify_OutputFuncPtr)(const char * string);
