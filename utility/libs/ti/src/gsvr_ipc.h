#ifndef _GSVR_IPC_H_
#define _GSVR_IPC_H_ "$Revision: 92 $ $Date: 2005-04-21 11:34:40 +0200 (Thu, 21 Apr 2005) $"
#include "versions.h"
HEADER_VERSION(_GSVR_IPC_H_);
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
#include <sys/types.h>
...
#define QCLASS(query) class query{\
   ...
   void Query()\
   {\
      GENSRVIPC.QueryExec(#query, (char*)&row, sizeof(t##query));\
   }\
   void RunProc()\
   {\
      GENSRVIPC.QueryRun(#query, (char*)&row, sizeof(t##query));\
   }\
}
