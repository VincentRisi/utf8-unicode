#ifndef __TPOSTSOCK__
#define __TPOSTSOCK__ "$Revision: 92 $ $Date: 2005-04-21 11:34:40 +0200 (Thu, 21 Apr 2005) $"
#include "versions.h"
HEADER_VERSION(__TPOSTSOCK__);
...
{
public:
  tPostSock(tString inifile);
  ~tPostSock() {closelog();};
  virtual void ServiceClient() = 0;
  void ServiceClientExit();
  void ServiceServerExit();
  void CreateChildren();
  int ReturnCode;
protected:
  tCBSockServer * SockSrv;
