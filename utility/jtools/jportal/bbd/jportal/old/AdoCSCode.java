...
public class AdoCSCode extends Generator
{
	...
	private static OutputStream openOutputStream(Table table, String output, PrintWriter outLog, String added) throws IOException
	{
		OutputStream outFile;
	...
	public static void generateEnumOrdinals(Table table, PrintWriter outData)
	{
		for (int i = 0; i < table.fields.size(); i++)
		{
			...
			if (field.enums.size() > 0)
			{
				...
				{
					bbd.jportal.Enum en = field.enums.elementAt(j);
