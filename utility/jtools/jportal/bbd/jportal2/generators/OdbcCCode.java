...
public class OdbcCCode extends Generator//BaseGenerator implements IBuiltInSIProcessor
{
  static private final Logger logger = LoggerFactory.getLogger(OdbcCCode.class);
//  public OdbcCCode()
//  {
