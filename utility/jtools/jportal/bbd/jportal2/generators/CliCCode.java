...
public class CliCCode extends Generator //BaseGenerator implements IBuiltInSIProcessor 
{
    ...
    private void generateSnips(Table table, String output) throws Exception {
        ...
        try (PrintWriter outData = new PrintWriter(new FileOutputStream(output + table.useName().toLowerCase() + "_snips.h")))
        {
            outData.println("// This code was generated, do not modify it, modify it at source and regenerate it.");
