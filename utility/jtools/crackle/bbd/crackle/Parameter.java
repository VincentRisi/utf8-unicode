...
public class Parameter
{
  ...
  public Action output;
	...
	public static boolean build(Vector list, Prototype prototype, boolean keepTee)
	{
    return build(list, prototype, keepTee, false);
  }
  public static boolean build(Vector list, Prototype prototype, boolean keepTee, boolean keepCase)
  {
  ...
  public static boolean buildBinu(Vector list, Prototype prototype)
  {
    list.removeAllElements();
    Parameter pd = null;
    boolean hasReturn = prototype.type.reference == Type.BYVAL && prototype.type.typeof != Type.VOID;
	...
	public static String languageName(Type type)
	{
		switch (language)
		{
			case JAVA_BASED: return type.javaName();
			case OBJC_BASED: return type.objcName();
			case CPP_BASED: return type.cName();
      case BINU_BASED: return type.binuName();
		}
    return type.name;
	}
