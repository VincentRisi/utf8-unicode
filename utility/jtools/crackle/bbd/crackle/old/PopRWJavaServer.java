...
public class PopRWJavaServer extends Generator
{
  ...
  public static void generate(bbd.crackle.Module module, String output, PrintWriter outLog)
  {
    errLog = outLog;
    try
    {
  ...
  public static void generateAssignCall(bbd.crackle.Module module, Prototype prototype, PrintWriter outData)
  {
  ...
  public static void generateAssignCalls(bbd.crackle.Module module, PrintWriter outData)
  {
  ...
  private static String outputDir(bbd.crackle.Module module, String output)
  {
  ...
  public static void generateCallStructs(bbd.crackle.Module module, String stdOutput, PrintWriter outLog) throws Throwable
  {
  ...
  public static void generateCaseCall(bbd.crackle.Module module, Prototype prototype, PrintWriter outData, boolean hasReturn)
  {
    for (int i = 0; i < parameterList.size(); i++)
    {
      Parameter pd = (Parameter) parameterList.elementAt(i);
  ...
  public static void generateDispatch(bbd.crackle.Module module, String stdOutput, PrintWriter outLog) throws IOException
  {
    String output = outputDir(module, stdOutput);
  ...
  public static void generateDispatchCase(bbd.crackle.Module module, Prototype prototype, PrintWriter outData)
  {
    outData.println("        case " + asMessage(prototype.name) + ":");
    outData.println("          _" + prototype.name + "();");
    outData.println("          break;");
  }
  public static void generateDispatchFunction(bbd.crackle.Module module, Prototype prototype, PrintWriter outData)
  {
    boolean hasReturn = buildParameterList(prototype);
  ...
  public static void generateDispatchProcess(bbd.crackle.Module module, PrintWriter outData)
  {
  ...
  public static void generateEnums(bbd.crackle.Module module, PrintWriter outData, PrintWriter outLog)
  {
    generateMessageEnums(module, outData);
  }
  public static void generateImplementation(bbd.crackle.Module module, String stdOutput, PrintWriter outLog) throws IOException
  {
    String output = outputDir(module, stdOutput);
  ...
  public static void generateInterface(bbd.crackle.Module module, String stdOutput, PrintWriter outLog) throws Throwable
  {
    String output = outputDir(module, stdOutput);
  ...
  public static void generateInterfaceCall(bbd.crackle.Module module, Prototype prototype, int no, PrintWriter outData) throws Throwable
  {
    boolean hasReturn = buildParameterList(prototype);
    String comma = "";
    String arrayed = prototype.type.reference == Type.ARRAYED ? "[]" : "";
  ...
  public static void generateInterfaceCalls(bbd.crackle.Module module, PrintWriter outData) throws Throwable
  {
    for (int i = 0; i < module.prototypes.size(); i++)
    {
      Prototype prototype = (Prototype)module.prototypes.elementAt(i);
  ...
  public static void generateInterfaceConsts(bbd.crackle.Module module, PrintWriter outData) throws Throwable
  {
    for (int i = 0; i < module.prototypes.size(); i++)
    {
      Prototype prototype = (Prototype)module.prototypes.elementAt(i);
  ...
  public static void generateMessageEnums(bbd.crackle.Module module, PrintWriter outData)
  {
  ...
  public static void generateReturnStructs(bbd.crackle.Module module, Prototype prototype, int no, PrintWriter outData) throws Throwable
  {
    boolean hasReturn = buildParameterList(prototype);
    if (hasReturn == true)
  ...
  public static void generateReturnStructs(bbd.crackle.Module module, PrintWriter outData) throws Throwable
  {
    for (int i = 0; i < module.prototypes.size(); i++)
    {
      Prototype prototype = (Prototype)module.prototypes.elementAt(i);
  ...
  private static void generateStructs(bbd.crackle.Module module, PrintWriter outData) throws Throwable
  {
    primeUsings(module);
  ...
  private static void generateStruct(bbd.crackle.Module module, Structure structure, PrintWriter outData) throws Throwable
  {
  ...
  public static void generateUsings(bbd.crackle.Module module, PrintWriter outData)
  {
    for (int i = 0; i < module.structures.size(); i++)
    {
      Structure structure = (Structure) module.structures.elementAt(i);
  ...
  private static void generateUsings(bbd.crackle.Module module, Vector fields, PrintWriter outData)
  {
    for (int i = 0; i < module.structures.size(); i++)
    {
      Structure structure = (Structure) module.structures.elementAt(i);
  ...
  public static void generateUsingsNoTables(bbd.crackle.Module module, PrintWriter outData)
  {
    for (int i = 0; i < module.structures.size(); i++)
    {
      Structure structure = (Structure) module.structures.elementAt(i);
  ...
  public static void generateUsingsNoTablesNoStructs(bbd.crackle.Module module, PrintWriter outData)
  {
    for (int i = 0; i < module.structures.size(); i++)
    {
      Structure structure = (Structure) module.structures.elementAt(i);
  ...
  public static void main(String[] args)
  {
    try
    {
      ...
      for (int i = 0; i < args.length; i++)
      {
        ...
        bbd.crackle.Module module = (bbd.crackle.Module) in.readObject();
  ...
  private static PrintWriter openOutData(String fileName, PrintWriter outLog) throws IOException
  {
  ...
  private static String packageName(bbd.crackle.Module module)
  {
