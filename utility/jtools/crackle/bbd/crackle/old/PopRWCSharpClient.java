...
public class PopRWCSharpClient extends Generator
{
  ...
  private static void generateCall(bbd.crackle.Module module, Prototype prototype, int no, PrintWriter outData)
  {
  ...
  private static void generateCalls(bbd.crackle.Module module, PrintWriter outData)
  {
   ...
   */
  private static void generateClasses(bbd.crackle.Module module, String output, PrintWriter outLog)
  {
    try
    {
  ...
  private static boolean generateCommon(bbd.crackle.Module module, Prototype prototype, int no, PrintWriter outData, String extra1)
  {
    Parameter pd = null;
    parameterList = new Vector();
    boolean hasReturn = prototype.type.reference == Type.BYVAL
  ...
  private static void generateEnums(bbd.crackle.Module module, PrintWriter outData)
  {
   ...
   */
  private static void generateMessageEnums(bbd.crackle.Module module, PrintWriter outData)
  {
  ...
  private static void generateMessageLookups(bbd.crackle.Module module, PrintWriter outData)
  {
  ...
  {
    boolean isArray = type.reference == Type.ARRAYED;
    String var = name;
  ...
  private static void generateStructs(bbd.crackle.Module module, PrintWriter outData)
  {
   ...
   * Sets up the writer and generates the general stuff
   */
  private static void generateStructs(bbd.crackle.Module module, String output, PrintWriter outLog)
  {
    try
    {
   ...
   */
  private static void generateTableEnums(bbd.crackle.Module module, PrintWriter outData)
  {
  ...
  private static void generateTableLookups(bbd.crackle.Module module, PrintWriter outData)
  {
    for (int i = 0; i < module.tables.size(); i++)
    {
      Table table = (Table) module.tables.elementAt(i);
  ...
  private static void generateUsings(bbd.crackle.Module module, PrintWriter outData)
  {
    usings = new Vector();
