...
public class PopUbiServer extends Generator
{
  ...
  private static void setPragmas(Module module)
  {
    ...
    qualifyEnums = pragmaVector.elementAt(no++).value;
  ...
  */
  ...
  private static boolean generateEmbedCCode(Module module, String output, PrintWriter outLog)
  {
    ...
    try
    {
      ...
      try
      {
        ...
        writeln("{");
        writeln("#if defined(PYZIP_MODULE_USAGE)");
        ...
        writeln("#else");
        writeln(1, "bstring scriptPath;");
        writeln(1, "bstring moduleList;");
        writeln(1, "config->Get(\"scriptPath\", scriptPath);");
        writeln(1, "interfaceHandle = InterfaceCBHandle.Create(callbackInterface);");
        writeln(1, "config->Get(\"moduleList\", moduleList);");
        writeln(1, "if (TPythonModule::LoadModules(this, config, moduleList.c_str()) == false)");
        writeln(2, "throw XPython(\"Python Modules failed to load or could not be initialised.\");");
        writeln(1, "char *argv[1];");
        writeln(1, "argv[0] = \"" + module.name + "Server\";");
        writeln(1, "interp = new TPython(interfaceHandle, (char*)scriptPath.c_str(), 1, argv, false);");
        writeln(1, "pyModule = interp->Import(\"" + module.name.toUpperCase() + "_CODE\", 2);");
        writeln("#endif");
  ...
  public PopUbiServer() {}
  private static final PopUbiServer us = new PopUbiServer();
  ...
  private static void generateMethodCall(Module module, Prototype prototype)
  {
    ...
    writeln(3, "PyObject* _signature = PyInt_FromLong(" + prototype.signature(true) + ");");
