...
public class PopGenC32
{
  ...
  */
  public static void generateC32Structs(Module module, PrintWriter outData, boolean doSwap)
  {
    generateC32Structs(module, outData, doSwap, true);
  }
  /**
  * Generates the data structures defined
  */
  public static void generateC32Structs(Module module, PrintWriter outData, boolean doSwap, boolean allMessages)
  {
  ...
  */
  private static void generateC32Actions(Module module, Prototype prototype, PrintWriter outData, String pad)
  {
    outData.println(pad+"/**");
    ...
    outData.println(pad+"* RETURNS: "+prototype.type.c32Name(false));
    outData.println(pad+"*/");
  }
  /**
  * Generates the prototypes defined
  */
  public static void generateC32Header(Module module, Prototype prototype, PrintWriter outData)
  {
    generateC32Actions(module, prototype, outData, "  ");
    String w1 = "";
    outData.print("  "+prototype.type.c32Def(prototype.name, false)+"(");
  ...
  * Generates the prototypes defined
  */
  public static void generateC32Interface(Module module, Prototype prototype, PrintWriter outData)
  {
    generateC32Actions(module, prototype, outData, "  ");
    String w1 = "";
    outData.print("  virtual " + prototype.type.c32Def(prototype.name, false) + "(");
    for (int i = 0; i < prototype.parameters.size(); i++)
    {
      Field parameter = (Field)prototype.parameters.elementAt(i);
      outData.print(w1 + parameter.type.c32Def(parameter.name, false));
  ...
  * Generates the prototypes defined
  */
  public static void generateVirtualC32Header(Module module, Prototype prototype, PrintWriter outData)
  {
    generateC32Actions(module, prototype, outData, "  ");
    String w1 = "";
    outData.print("  virtual " + prototype.type.c32Def(prototype.name, false) + "(");
  ...
  */
  public static void generateC32ImplCode(Module module, Prototype prototype, PrintWriter outData)
  {
    generateC32Actions(module, prototype, outData, "");
    String w1 = "";
  ...
  * Generates the implementation code
  */
  public static void generateUbiC32ImplCode(Module module, Prototype prototype, PrintWriter outData)
  {
    generateC32Actions(module, prototype, outData, "");
    String w1 = "";
    outData.print(prototype.type.c32Def("T" + module.name + "::" + prototype.name, false) + "(");
  ...
  * Generates the prototypes defined
  */
  public static void generateC32Swaps(Module module, Prototype prototype, Field field, Operation op, PrintWriter outData)
  {
  ...
  * Generates the prototypes defined
  */
  public static void generateC32Trims(Module module, Prototype prototype, Field field, Operation op, PrintWriter outData)
  {
    String w1 = "", w2 = "", w3 = ".", w4 = "", w5 = "", w6 = "";
    int n=0;
    if (field.needsTrim() == true
  ...
  public static void generateC32StructSwaps(Module module, Prototype prototype, Field field, Operation op, PrintWriter outData)
  {
    if (field.isStruct(module) == true)
    {
      generateC32Swaps(module, prototype, field, op, outData);
      generateC32Trims(module, prototype, field, op, outData);
    }
  }
  public static void generateC32NonStructSwaps(Module module, Prototype prototype, Field field, Operation op, PrintWriter outData)
  {
