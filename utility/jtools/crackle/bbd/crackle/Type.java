...
public class Type implements Serializable
{
  ...
  public String c32Def(String aName)
  {
    return c32Def(aName, true);
  }
  public String c32Def(String aName, boolean withBool)
  {
    String result = c32Name(withBool);
    if (reference == Type.BYPTR)
      result = result + "*";
    else if (reference == Type.BYREF)
      result = result + "&";
  ...
  public String cDefBind11(String aName)
  {
    String result = cNameUbi();
    if (reference == Type.BYPTR)
      result = result + "*";
  ...
  public String c32DefRefPAsP(String aName, boolean withBool)
  {
    String result = c32Name(withBool);
    if (reference == Type.BYPTR || reference == Type.BYREFPTR)
      result = result + "*";
  ...
  public String c32Name()
  {
    return c32Name(true);
  }
  public String c32Name(boolean withBool)
  {
    String sign = "";
    if (isUnsigned)
      sign = "unsigned ";
